...
```
Use `getConfigurations()` method to get the Imported Configuration. `The getConfigurations()` method returns the configurations as a Dictionary with Index as Keys (```0:{},1:{},2:{},...```) 
```
configurations = configObject.getConfigurations()
```
